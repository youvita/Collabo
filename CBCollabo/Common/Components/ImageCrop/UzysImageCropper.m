...
- (id)initWithImage:(UIImage*)newImage andframeSize:(CGSize)frameSize andcropSize:(CGSize)cropSize
{
    ...
    if(self)
    {
        ...
        _cropRect = CGRectMake(cropX+ _imgViewframeInitValue.origin.x, cropY+ _imgViewframeInitValue.origin.y-40, _imageScale*cropSize.width, _imageScale*cropSize.height+50);
        ...
        UIImageView *centerImageView = [[UIImageView alloc]initWithFrame:_cropRect];
        centerImageView.image           = [UIImage imageNamed:@"crop_rectangle.png"];
        centerImageView.userInteractionEnabled = YES;
        
        UIImageView *cropimg = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@""]] autorelease];
