...
//        [self.navigationItem setRightBarButtonItem:doneButton animated:NO];
        ...
        UIBarButtonItem *Back =[[UIBarButtonItem alloc]initWithImage:resizedImage landscapeImagePhone:nil style:UIBarButtonItemStyleDone target:self action:@selector(done:)];
         [self.navigationItem setRightBarButtonItem:Back animated:NO];
