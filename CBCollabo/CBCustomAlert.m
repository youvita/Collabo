...
#import "Constants.h"
#define MAX_ALERT_HEIGHT 200.0

@implementation CBCustomAlert
...
//        
        ...
        UIImageView *AlertImgView = [[UIImageView alloc] init];
        AlertImgView.backgroundColor = RGB(245, 245, 245);
        AlertImgView.frame = CGRectMake(0, 0, 300, 73);
        AlertImgView.layer.cornerRadius = 5;
        
        float alert_width = AlertImgView.frame.size.width;
        float alert_height = AlertImgView.frame.size.height;
        ...
        if (title)
        {
            TitleLbl = [[UILabel alloc] initWithFrame:CGRectMake(10.0, 5, alert_width-20.0, 30.0)];
            TitleLbl.adjustsFontSizeToFitWidth = YES;
            TitleLbl.font = [UIFont boldSystemFontOfSize:15.0];
            TitleLbl.textAlignment = UITextAlignmentCenter;
            TitleLbl.backgroundColor = [UIColor clearColor];
            TitleLbl.textColor = RGB(80, 80,165);
            TitleLbl.text = title;
        ...
        UIImageView *AlertLineTitle = [[UIImageView alloc] init];
        AlertLineTitle.backgroundColor = RGB(105, 100, 210);
        AlertLineTitle.frame = CGRectMake(0, 39,300, 1);
        [AlertImgView addSubview:AlertLineTitle];

        
        UIImageView *AlertInputBg = [[UIImageView alloc] init];
        AlertInputBg.frame = CGRectMake(16, 50,250,40);
        AlertInputBg.image = [UIImage imageNamed:@"login_input.png"];
        [AlertImgView addSubview:AlertInputBg];
        
        UITextField *AlertField = [[UITextField alloc]init];
        AlertField.frame = CGRectMake(20, 49,240,35);
//        AlertField.backgroundColor = [UIColor whiteColor];
        AlertField.borderStyle = UITextBorderStyleNone;
        [AlertInputBg addSubview:AlertField];
        ...
        if (cancelButtonTitle && otherButtonTitle)
        {
            ...
            [AlertImgView addSubview:OtherBtn];
        }
